void controller()
{
  ...
  analogWrite(PWMpin_theta1, min(PWM_theta1,3600));
  digitalWrite(enablepin_theta1, HIGH);
  
  if (controllaw_theta1 > 0)
  {
    digitalWrite(directionpin_theta1,LOW);
  }
  else
  {
    digitalWrite(directionpin_theta1, HIGH);
  }
